...
def calc(hands, board = '', dead = '', iters = 1000000):
...
# iters, which we also passed, size, and MC. We're
# pretty much only concerned with ev, which will be
# of the form '[float1, float2]', where float1 + float2 = 1
# and they represent the relative odds of the respective
# hand winning the round
